...
class ReportTypes(TextChoices):
    ...
    # новые типы для дифф-отчётов
    DETAILED_DEVICE_UPDATES = "DETAILED_DEVICE_UPDATES", "Детализированные изменения Счетчиков"
    DETAILED_DEVICE_DELETIONS = "DETAILED_DEVICE_DELETIONS", "Детализированные удаления Счетчиков"
    DETAILED_DEVICE_ADDED = "DETAILED_DEVICE_ADDED", "Детализированные добавления Счетчиков"
    DETAILED_BANKBOOK_UPDATES = "DETAILED_BANKBOOK_UPDATES", "Детализированные изменения Лицевых счетов"
